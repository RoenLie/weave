...
// injected imports
import '/../docs/pages/button/button.demo.ts';
import '@roenlie/mirage-docs/app/components/page/page-header.js';
// hoisted


class diqnageqtx extends PageAdapter {
	...
	<midoc-page-header
		component-name="mm-button"
		.declaration=${this.metadata['mm-button']}
	></midoc-page-header>
</div>
<p><mm-button-demo></mm-button-demo></p>
...
const module = new ContainerModule(({rebind}) => {
	rebind('midoc-page').toConstantValue(diqnageqtx);
});
