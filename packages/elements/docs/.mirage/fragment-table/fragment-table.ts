...
// injected imports
import '/../docs/pages/fragment-table/fragment-table.demo.ts';
import '@roenlie/mirage-docs/app/components/page/page-header.js';
// hoisted


class shhbzboore extends PageAdapter {
	...
	<midoc-page-header
		component-name="f-table"
		.declaration=${this.metadata['f-table']}
	></midoc-page-header>
</div>
<p><mm-fragment-table-demo></mm-fragment-table-demo></p>
...
const module = new ContainerModule(({rebind}) => {
	rebind('midoc-page').toConstantValue(shhbzboore);
});
