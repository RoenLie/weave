...
// injected imports
import '/../docs/pages/input/input.demo.ts';
import '@roenlie/mirage-docs/app/components/page/page-header.js';
// hoisted


class nenwlriojq extends PageAdapter {
	...
	<midoc-page-header
		component-name="mm-input"
		.declaration=${this.metadata['mm-input']}
	></midoc-page-header>
</div>
<p><mm-input-demo></mm-input-demo></p>
...
const module = new ContainerModule(({rebind}) => {
	rebind('midoc-page').toConstantValue(nenwlriojq);
});
