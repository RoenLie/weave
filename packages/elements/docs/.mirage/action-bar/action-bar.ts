...
// injected imports
import '/../docs/pages/action-bar/action-bar.demo.ts';
import '@roenlie/mirage-docs/app/components/page/page-header.js';
// hoisted


class kvoevcfnjn extends PageAdapter {
	...
	<midoc-page-header
		component-name="mm-action-bar"
		.declaration=${this.metadata['mm-action-bar']}
	></midoc-page-header>
</div>
<p><mm-action-bar-demo></mm-action-bar-demo></p>
...
const module = new ContainerModule(({rebind}) => {
	rebind('midoc-page').toConstantValue(kvoevcfnjn);
});
