...
// injected imports
import '/../docs/pages/text/text.demo.ts';
import '@roenlie/mirage-docs/app/components/page/page-header.js';
// hoisted


class cktjpfrlmq extends PageAdapter {
	...
	<midoc-page-header
		component-name="mm-text"
		.declaration=${this.metadata['mm-text']}
	></midoc-page-header>
</div>
<p><mm-text-demo></mm-text-demo></p>
...
const module = new ContainerModule(({rebind}) => {
	rebind('midoc-page').toConstantValue(cktjpfrlmq);
});
