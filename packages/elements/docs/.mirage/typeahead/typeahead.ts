...
// injected imports
import '/../docs/pages/typeahead/typeahead.demo.ts';
import '@roenlie/mirage-docs/app/components/page/page-header.js';
// hoisted


class jmhwlmmcpb extends PageAdapter {
	...
	<midoc-page-header
		component-name="mm-typeahead"
		.declaration=${this.metadata['mm-typeahead']}
	></midoc-page-header>
</div>
<p><mm-typeahead-demo></mm-typeahead-demo></p>
...
const module = new ContainerModule(({rebind}) => {
	rebind('midoc-page').toConstantValue(jmhwlmmcpb);
});
